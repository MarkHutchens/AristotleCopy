...
def processRequest(req):
    print ("started processing - I am super confused")
    if req.get("result").get("action") != "yahooWeatherForecast":
        print("wtf i spelled it right")
        return {}
    ...
    print(result, "totally not gonna crash now")
    data = json.loads(result)
    print("Made past data")
    res = makeWebhookResult(data)
    print("Made it past res")
    return res
